...
struct LightColors {
    ...
    struct Link {
        /// Primary interactive color. Always the 500 value for the corresponding brand color
        static var one = ThemeManager.shared.color(for: "link-01")
        /// Secondary ui elements such as toast notifications.
        static var two = ThemeManager.shared.color(for: "link-02")
    }
    ...
    struct Contrast {
        ...
        static var three = ThemeManager.shared.color(for: "contrast-03")
    }
    ...
    struct Outline {
        ...
        static var three = ThemeManager.shared.color(for: "outline-03")
    }
    
    struct Icons {
        /// Icons
        static var one = ThemeManager.shared.color(for: "icons-01")
        /// Icons in default colors
        static var two = ThemeManager.shared.color(for: "icons-02")
    }
...
struct LightInversedColors {
    ...
    struct Background {
        /// Default page background
        static var one = ThemeManager.shared.color(for: "inverse-background-01")
    }
    
    struct Link {
        /// Primary links, ghost button on light-inverse-background-01
        static var one = ThemeManager.shared.color(for: "inverse-link-01")
    }
    
    struct Text {
        /// Primary text; Body copy; Headers; Hover text color for light-inverse-text-02 on light-inverse-background-01
        static var one = ThemeManager.shared.color(for: "inverse-text-01")
        /// Secondary text; Input labels on light-inverse-background-01
        static var two = ThemeManager.shared.color(for: "inverse-text-02")
    }
    
    struct Contrast {
        /// Text or icons on top of alert or success colors
        static var three = ThemeManager.shared.color(for: "inverse-contrast-03")
    }
    
    struct Outline {
        /// Default line elements on light-inverse-background-01
        static var one = ThemeManager.shared.color(for: "inverse-outline-01")
        /// Structural line elements on light-inverse-background-01
        static var two = ThemeManager.shared.color(for: "inverse-outline-02")
        /// Selected or hover line elements on light-inverse-background-01
        static var three = ThemeManager.shared.color(for: "inverse-outline-03")
    }
    
    struct Icons {
        /// Icons in default colors
        static var one = ThemeManager.shared.color(for: "inverse-icons-01")
        /// Icons in default colors
        static var two = ThemeManager.shared.color(for: "inverse-icons-02")
    }
}
