...
class SwapViewController: BaseTableViewController<SwapCoordinator,
    ...
    override func displayMessage(responseDisplay: MessageModels.ResponseDisplays) {
        ...
        confirmButton.wrappedView.isEnabled = responseDisplay.error == nil && dataStore?.fromFiatAmount != 0
    ...
    func displaySetAmount(responseDisplay: SwapModels.Amounts.ResponseDisplay) {
        ...
        confirmButton.wrappedView.isEnabled = responseDisplay.amounts.fromFiatAmount != 0
