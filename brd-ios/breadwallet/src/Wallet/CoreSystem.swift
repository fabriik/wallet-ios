...
class CoreSystem: Subscriber {
    ...
    private let queue = DispatchQueue(label: "com.placeholder.two.CoreSystem", qos: .utility)
    private let listenerQueue = DispatchQueue(label: "com.placeholder.two.CoreSystem.listener", qos: .utility)
