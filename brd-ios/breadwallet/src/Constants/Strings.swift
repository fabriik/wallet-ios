  ...
  internal enum Alert {
    ...
    internal enum Keystore {
      internal enum Generic {
        /// Keystore error
        internal static let android = L10n.tr("Localizable", "Alert.keystore.generic.android", fallback: "There is a problem with your Android OS keystore, please contact hello@placeholder.com")
      }
