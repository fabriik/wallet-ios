...
internal enum L10n {
  ...
  internal enum Alert {
    ...
    internal enum Keystore {
      internal enum Generic {
        /// Keystore error
        internal static let android = L10n.tr("Localizable", "Alert.keystore.generic.android", fallback: "There is a problem with your Android OS keystore, please contact hello@company.com")
      }
  ...
  internal enum Import {
    ...
    internal static let message = L10n.tr("Localizable", "Import.message", fallback: "Importing a wallet transfers all the money from your other wallet into your Rockwallet using a single transaction.")
