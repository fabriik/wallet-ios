...
var WalletSecAttrService: String {
    if E.isRunningTests { return "com.placeholder.two.testnetQA.tests" }
    #if TESTNET
    return "com.placeholder.two.testnetQA"
    #elseif INTERNAL
    return "com.placeholder.two.internalQA"
    #else
    return "com.placeholder.two"
    #endif
}
